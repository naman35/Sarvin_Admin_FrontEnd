const FreeCard = () => {
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#f4ccc4] via-[#f14242] to-brand-500 pb-4">
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        <p className="text-lg font-bold text-white">Redirect To Portal</p>
        <p className="mt-1 px-4 text-center text-sm text-white">
          Sarvin Influencer and Sarvin Brands Portal
        </p>
