const Checkbox = (props) => {
  ...
  return (
    <input
      ...
      justify-center rounded-md border border-gray-800 text-gray-300 outline-none transition duration-[0.2s]
      checked:border-none checked:text-gray-900 hover:cursor-pointer  ${
        color === "red"
