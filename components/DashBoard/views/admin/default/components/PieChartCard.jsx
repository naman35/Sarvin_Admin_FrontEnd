...
const PieChartCard = ({ label = "Brand Categories" }) => {
  return (
      ...
      <div className="flex flex-row !justify-between rounded-2xl px-6 py-3 shadow-2xl shadow-shadow-500">
        <div className="flex flex-col items-center justify-center">
          <div className="flex items-center justify-center">
            ...
            <p className="ml-1 text-sm font-normal text-gray-600">SkinCare</p>
          </div>
          <p className="mt-px text-xl font-bold text-navy-700   ">63%</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-px text-xl font-bold text-navy-700  ">25%</p>
        </div>
      </div>
    </Card>
  );
